...
public class ConnectionThread extends Thread {
    ...
    private static final String SERVER_IP = "http://104.199.43.149/whatsapp/server";
    ...
    public ConnectionThread(Handler handler, OnResponseListener listener, JSONObject data){
        this.listener = listener;
        this.data = data;
